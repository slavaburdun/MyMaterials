...
import controllers.DAO.CRUD.interfaces.TourDAO;
...
public class MySQLTourDAO implements TourDAO {
    ...
    public MySQLTourDAO(Logger log) throws ConnectionToDBException, IOException {
        try {
            MySQLTourDAO.log = log;
    ...
    public int insert(Tour entity) {
        try {
            ...
            int id = command.executeStatement(properties.getProperty("tour_insert"), log, args);
            entity.setId(id);
            return id;
        } catch (SQLException ex) {
        }
    ...
    public boolean update(Tour entity) {
        try {
            ...
            if (command.executeStatement(properties.getProperty("tour_update"), log, args) > 0) {
                return true;
            }
    ...
    public Tour get(int id) {
        try {
            ...
            tour.setId(id);
            Object[] args = {id};
            ResultSet result = command.getResultSet(properties.getProperty("tour_get"), log, args);
            if (result.next()) {
    ...
    public boolean delete(Tour entity) {
        try {
            ...
            ResultSet result = command.getResultSet(properties.getProperty("tour_delete"), log, args);
            return true;
        } catch (SQLException ex) {
        }
        return false;
    ...
    public List<Tour> getAll() {
        try {
            ...
            Object[] args = {};
            ResultSet result = command.getResultSet(properties.getProperty("tour_getAll"), log, args);
            while (result.next()) {
                Tour tour = new Tour();
                tour.setDiscount(result.getDouble("discount"));
                tour.setPrice(result.getDouble("price"));
    ...
    public List<Tour> getToursOfCustomer(Customer owner) {
        try {
            ...
            ResultSet result = command.getResultSet(properties.getProperty("tour_getTourOfCustomer"), log, args);
            while (result.next()) {
                Tour tour = new Tour();
                tour.setDiscount(result.getDouble("discount"));
                tour.setPrice(result.getDouble("price"));
    ...
    public boolean setOwner(Customer owner, Tour entity) {
        try {
            ...
            if (command.executeStatement(properties.getProperty("tour_updateCustomer"), log, args) > 0) {
                return true;
            }
            return false;
        } catch (SQLException ex) {
    ...
    public boolean setTourFree(Tour entity) {
        try {
            ...
            if (command.executeStatement(properties.getProperty("tour_setTourFree"), log, args) > 0) {
                return true;
            }
        } catch (SQLException e) {
            e.printStackTrace();
    ...
    public List<Tour> getFreeTours() {
        try {
            LinkedList<Tour> tours = new LinkedList<Tour>();
            Object[] args = {};
            ResultSet result = command.getResultSet(properties.getProperty("tour_getFreeTours"), log, args);
            while (result.next()) {
                Tour tour = new Tour();
                tour.setDiscount(result.getDouble("discount"));
                tour.setPrice(result.getDouble("price"));
    ...
    public boolean hasOwner(Tour tour) {
        try {
            ...
            ResultSet result = command.getResultSet(properties.getProperty("tour_hasOwner"), log, args);
            if (result.next()) {
                return true;
            }
            return false;
